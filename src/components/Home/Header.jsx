...
const Header = () => {
    return (
        <main id="home" className="hero py-5 my-2 lg:my-8 relative overflow-x-hidden">
          <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            <div className="md:w-2/3 lg:w-3/5">
              ...
              <a href="https://wa.me/966565477623" className="btn btn-success text-white">
...
<div data-aos="zoom-in-left" className="min-w-64 max-w-96 rounded-lg carousel">
  <div className="carousel-item w-full">
    <img loading="lazy" src="https://jisan901.github.io/Assets-All/client108/wam3.png" className="h-full w-full" alt="Air conditioner" />
  </div> 
  <div className="carousel-item w-full">
    <img loading="lazy" src="https://jisan901.github.io/Assets-All/client108/wam.png" className="" alt="washing machine" />
  </div> 
  <div className="carousel-item w-full">
    <img loading="lazy" src="https://jisan901.github.io/Assets-All/client108/m.png" className="" alt="furniture" />
  </div> 
</div>
    )
}